...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.54\textwidth]{figures/dfd-level-0.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.54\textwidth]{figures/dfd-level-1.png}
  \caption{Level 1 data-flow diagram for implemented processes and persistent
  stores.}
  \label{fig:dfd1}
\end{figure}
